...
public class ExcelData {
	...
	// Calcul�e: prefix de CUF section => premier elt avant '_' (ex INS_Gestion de l'ins => INS) 
	private String id_section_3;
	
	// Calcul�e: fin du  CUF section => chaine de caract�re apr�s le premier '_'  (ex INS_Gestion de l'ins => Gestion de l'ins)
	...
	//calcul�e: si cat�gorie = Exigence (DOIT)=> valeur EXIGENCE, si cat�gorie = Pr�conisation (PEUT) valeur=PRECONISATION 
	...
	//R�f�rence du cas de test TODO => liste...de CT contenant une liste de pas de test
